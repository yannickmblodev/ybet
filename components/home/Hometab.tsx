                ...
                <div className="main-tabbing">
                    <ul className="nav">
                        <li className="nav-item">
                            <Link className="nav-link link-secondary active" id="all-tab" data-bs-toggle="tab" data-bs-target="#betsall" href="#"><span>Tout</span></Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link link-secondary" id="combo-tab01" data-bs-toggle="tab" data-bs-target="#combo01" href="#"><span>Live</span></Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link link-secondary" id="combo-tab02" data-bs-toggle="tab" data-bs-target="#combo02" href="#"><span>Aujourd'hui</span></Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link link-secondary" id="combo-tab03" data-bs-toggle="tab" data-bs-target="#combo03" href="#"><span>Demain</span></Link>
                        </li>
                        <li className="nav-item">
